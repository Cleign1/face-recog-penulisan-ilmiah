        ...
        <div className="p-6 text-black">
          <div className="pt-24">
            <div className="max-w-2xl mx-auto border-black border-4 rounded-3xl p-8">
              ...
              Website ini dibuat dengan Framework Next.js 14 dan Tailwind CSS. Dengan tambahan fitur authentikasi dengan NextAuth, Penyimpanan Database dengan PostgreSQL dengan platform Neon dengan dan face recognition dan face verification menggunakan library Face-Api.js
              </p>
            </div>
          </div>
        </div>
