      ...
      <nav className="pt-10">
        <ul className="space-y-5">
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/siswa" className="text-xl text-left">
              Dashboard
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/siswa/profil" className="text-xl">
              Profil
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/siswa/presensi" className="text-xl">
              Presensi
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/siswa/kelas" className="text-xl">
              Kelas
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/siswa/tentang" className="text-xl">
              Tentang
            </Link>
          </li>
