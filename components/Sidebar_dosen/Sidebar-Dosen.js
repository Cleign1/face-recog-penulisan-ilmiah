      ...
      <nav className="pt-10">
        <ul className="space-y-5">
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/dosen" className="text-xl text-left">
              Dashboard
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/dosen/profil" className="text-xl">
              Profil
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/dosen/datapresensi" className="text-xl">
              Data Presensi
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/dosen/kelas" className="text-xl">
              Kelas
            </Link>
          </li>
          <li className="flex items-center justify-center border rounded-lg bg-[#CDE8E5] p-2 hover:bg-[#EEF7FF]">
            ...
            <Link href="/dosen/tentang" className="text-xl">
              Tentang
            </Link>
          </li>
